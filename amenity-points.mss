...
>>>>>>> c752a1a... Add radio telescope icon and code in amenitys and project
    marker-fill: #3f3f3f;
    marker-placement: interior;
    marker-clip: false;
  }
